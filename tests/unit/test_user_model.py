"""
This file (test_user_model.py) contains the unit tests for the User model.
"""
...
def test_new_user(new_user):
    ...
    """
    assert new_user.email == 'bernard@gmail.com'
    assert new_user.hashed_password != 'whatPasswrd'
...
def test_setting_password(new_user):
    ...
    assert not new_user.is_correct_password('whatPasswrd')
